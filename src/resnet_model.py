...
Instead of the typical 4 layers of ResNet-18, we use 3 layers with [2, 2, 1] blocks respectively.
I leave the commented code from previous versions as proof of our work.
'''
# #shortcut version 3
